...
//
//     final postModelDroid = postModelDroidFromJson(jsonString);

import 'dart:convert';

PostModelDroid postModelDroidFromJson(String str) =>
    PostModelDroid.fromJson(json.decode(str));

String postModelDroidToJson(PostModelDroid data) => json.encode(data.toJson());

class PostModelDroid {
  PostModelDroid({
    this.kind,
    this.nextPageToken,
    this.items,
  ...
  factory PostModelDroid.fromJson(Map<String, dynamic> json) => PostModelDroid(
        kind: json["kind"],
